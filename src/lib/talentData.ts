...
export const SURVIVAL_NODES: TalentNodeDef[] = [
  ...
  // ROW 2 (API row 3)
  { id:'wildfire_bomb', apiNodeId:102264, spellId:259495, name:'Wildfire Bomb', type:'active', maxPts:1, row:2, col:3,
  ...
  { id:'bomb_choice', apiNodeId:109309, spellId:null, name:'Shrapnel Bomb / Flamebreak', type:'choice', maxPts:1, row:5, col:1,
  ...
  { id:'bloodseeker', apiNodeId:102270, spellId:260248, name:'Bloodseeker', type:'passive', maxPts:1, row:5, col:3,
    parents:['boomstick','lunge'], desc:'You and your pet gain 10% attack speed for every bleeding enemy within 12 yds.' },
  { id:'quick_reload', apiNodeId:110162, spellId:1272136, name:'Quick Reload', type:'passive', maxPts:1, row:5, col:4,
    parents:['boomstick'], desc:"Boomstick's cooldown is reduced by 15 sec." },
  { id:'flankers_advantage', apiNodeId:102279, spellId:459964, name:"Flanker's Advantage", type:'passive', maxPts:1, row:5, col:5,
  ...
  { id:'two_against_many', apiNodeId:110163, spellId:1251718, name:'Two Against Many', type:'passive', maxPts:1, row:5, col:7,
  ...
  // ROW 6 (API row 7)
  { id:'mongoose_fury', apiNodeId:109310, spellId:1252708, name:'Mongoose Fury', type:'passive', maxPts:1, row:6, col:2,
  ...
  { id:'ammo_choice', apiNodeId:109316, spellId:null, name:'Mongoose Rounds / Wildfire Shells', type:'choice', maxPts:1, row:6, col:3,
  ...
  { id:'shellshock', apiNodeId:109319, spellId:1252931, name:'Shellshock', type:'passive', maxPts:1, row:6, col:5,
  ...
  { id:'sic_em', apiNodeId:109305, spellId:1253137, name:"Sic 'Em", type:'passive', maxPts:1, row:6, col:6,
  ...
  // ROW 7 (API row 8)
  { id:'bloody_claws', apiNodeId:109307, spellId:null, name:'Bloody Claws / Wallop', type:'choice', maxPts:1, row:7, col:1,
  ...
  { id:'improved_wfb', apiNodeId:102289, spellId:321290, name:'Improved Wildfire Bomb', type:'passive', maxPts:2, row:7, col:2,
    parents:['mongoose_fury'], desc:'Wildfire Bomb deals 6% additional damage.' },
  { id:'bonding', apiNodeId:109311, spellId:1262442, name:'Bonding', type:'passive', maxPts:1, row:7, col:3,
    parents:['mongoose_fury','ammo_choice'], desc:'Mastery increased by 3%. You gain 5% increased Mastery from all Mastery sources.' },
  { id:'sweeping_spear', apiNodeId:109313, spellId:378950, name:'Sweeping Spear', type:'passive', maxPts:2, row:7, col:4,
    parents:['ammo_choice','shellshock'], desc:'Raptor Strike damage increased by 10%.' },
  { id:'vuln_choice', apiNodeId:102282, spellId:null, name:'Vulnerability / Blackrock Munitions', type:'choice', maxPts:1, row:7, col:5,
  ...
  { id:'shower_of_blood', apiNodeId:109304, spellId:1253053, name:'Shower of Blood', type:'passive', maxPts:2, row:7, col:6,
...
export const SENTINEL_NODES: TalentNodeDef[] = [
  ...
  { id:'sanctified_arms', apiNodeId:94981, spellId:1253831, name:'Sanctified Armaments', type:'passive', maxPts:1, row:2, col:5,
    parents:['sentinel_keystone'], desc:"An additional 15% of Raptor Strike's damage is dealt as Arcane damage over 6 sec." },
  { id:'moonlight_chakram', apiNodeId:109807, spellId:1264902, name:'Moonlight Chakram', type:'passive', maxPts:1, row:2, col:7,
  ...
  { id:'stargazer_choice', apiNodeId:94958, spellId:null, name:'Stargazer / Open Fire', type:'choice', maxPts:1, row:3, col:1,
  ...
  { id:'cant_miss', apiNodeId:94990, spellId:1253830, name:"Can't Miss, Won't Miss", type:'passive', maxPts:1, row:3, col:3,
    parents:['moons_blessing'], desc:'Tip of the Spear damage bonus increased by 4%. Takedown duration increased by 2 sec.' },
  { id:'invigorating_pulse', apiNodeId:94971, spellId:450379, name:'Invigorating Pulse', type:'passive', maxPts:1, row:3, col:5,
  ...
  { id:'twilight_choice', apiNodeId:110028, spellId:null, name:'Twilight Requiem / Stalk and Strike', type:'choice', maxPts:1, row:3, col:7,
  ...
  { id:'arcane_talons', apiNodeId:94970, spellId:1253846, name:'Arcane Talons', type:'passive', maxPts:1, row:4, col:1,
    parents:['stargazer_choice'], desc:"Sentinel's Mark further increases the damage of Wildfire Bomb by 50%." },
  { id:'lunar_calling', apiNodeId:94965, spellId:1253852, name:'Lunar Calling', type:'passive', maxPts:1, row:4, col:3,
  ...
  { id:'cond_choice', apiNodeId:94980, spellId:null, name:"Conditioning / Scout's Vigil", type:'choice', maxPts:1, row:4, col:5,
  ...
  { id:'radiant_edge', apiNodeId:109805, spellId:1264903, name:'Radiant Edge', type:'passive', maxPts:1, row:4, col:7,
    parents:['twilight_choice'], desc:'Your Moonlight Chakram deals 25% increased damage each time it bounces.' },
  { id:'lunar_storm', apiNodeId:94978, spellId:1253732, name:'Lunar Storm', type:'passive', maxPts:1, row:5, col:4,
...
export const PACK_LEADER_NODES: TalentNodeDef[] = [
  ...
  { id:'lone_wolf', apiNodeId:94985, spellId:472358, name:'Pack Mentality', type:'passive', maxPts:1, row:2, col:1,
    parents:['vicious_hunt'], desc:'Howl of the Pack Leader increases the damage of your Kill Command by 50%. Summoning a Beast reduces the cooldown of Kill Command by 4.0 sec.' },
  { id:'horn', apiNodeId:94992, spellId:472352, name:'Dire Summons', type:'passive', maxPts:1, row:2, col:3,
    parents:['vicious_hunt'], desc:'Kill Command reduces the cooldown of Howl of the Pack Leader by 1.0 sec. Raptor Strike reduces the cooldown of Howl of the Pack Leader by 1.0 sec.' },
  { id:'pathfinding_pl', apiNodeId:94962, spellId:472357, name:'Better Together', type:'passive', maxPts:1, row:2, col:5,
    parents:['vicious_hunt'], desc:'Damage dealt by your pets is increased by 2%. Kill Command damage increased by 10%.' },
  { id:'shoes_choice', apiNodeId:94979, spellId:null, name:'Slicked Shoes / Masterful Call', type:'choice', maxPts:1, row:2, col:7,
  ...
  { id:'ursine_choice', apiNodeId:94972, spellId:null, name:'Ursine Fury / Sharpened Claws', type:'choice', maxPts:1, row:3, col:1,
  ...
  { id:'turtle', apiNodeId:94967, spellId:472707, name:'Shell Cover', type:'passive', maxPts:1, row:4, col:3,
  ...
  { id:'hoof_choice', apiNodeId:109804, spellId:null, name:"Hoof and Blade / Wyvern's Gaze", type:'choice', maxPts:1, row:4, col:5,
    parents:['boar_head'], desc:"Hoof and Blade: Hogstrider Raptor Strike +50% dmg & +3 targets. Wyvern's Gaze: Wyvern buff +2s.",
    choiceA: { name:'Hoof and Blade', spellId:1264797, desc:'Hogstrider further increases the damage of Raptor Strike by 50% and it now strikes up to 3 additional targets.' },
    choiceB: { name:"Wyvern's Gaze", spellId:1264792, desc:'The damage bonus from your Wyvern now lasts an additional 2.0 sec.' } },
  { id:'monster_fang', apiNodeId:109802, spellId:1264775, name:'Sharpened Fangs', type:'passive', maxPts:1, row:4, col:7,
...
// ── BLIZZARD OFFICIAL ICON CDN URLS ──────────────────────────
// Source: Blizzard Game Data API /data/wow/media/spell/{spellId}
// All URLs are from render.worldofwarcraft.com (official Blizzard CDN)

const B = "https://render.worldofwarcraft.com/us/icons/56";

export const WOWHEAD_ICON_FALLBACKS: Record<number, string> = {
  // ── Survival Spec ──
  259489: `${B}/ability_hunter_killcommand.jpg`,
  186270: `${B}/ability_hunter_raptorstrike.jpg`,
  259495: `${B}/inv_wildfirebomb.jpg`,
  260285: `${B}/ability_bossmannoroth_glaivethrust.jpg`,
  264332: `${B}/spell_mage_flameorb.jpg`,
  378934: `${B}/inv_polearm_2h_kultirasharpoon_a_01.jpg`,
  1261193: `${B}/inv_musket_04.jpg`,
  1251717: `${B}/inv_coordinatedassault.jpg`,
  260248: `${B}/ability_druid_primaltenacity.jpg`,
  1272136: `${B}/ability_vehicle_reloadammo.jpg`,
  459964: `${B}/ability_hunter_beastmastery.jpg`,
  1251718: `${B}/ability_hunter_separationanxiety.jpg`,
  1252708: `${B}/ability_hunter_mongoosebite.jpg`,
  1252931: `${B}/inv_10_engineering2_pvpflaregun_color1.jpg`,
  1253137: `${B}/ability_hunter_sickem.jpg`,
  321290: `${B}/inv_eng_bombfire.jpg`,
  1262442: `${B}/ability_hunter_beastwithin.jpg`,
  378950: `${B}/spell_warrior_wildstrike.jpg`,
  1253053: `${B}/spell_druid_bloodythrash.jpg`,
  459939: `${B}/ability_hunter_potentvenom.jpg`,
  378937: `${B}/inv_misc_bomb_05.jpg`,
  1250646: `${B}/inv12_ability_hunter_takedown.jpg`,
  378955: `${B}/ability_hunter_masterscall.jpg`,
  1251592: `${B}/inv_10_blacksmithing_craftedoptional_blacksmithdye_fire.jpg`,
  1272139: `${B}/ability_hunter_spearhead.jpg`,
  1251790: `${B}/ability_hunter_ferociousinspiration.jpg`,
  460198: `${B}/inv_misc_5potionbag_special.jpg`,
  459843: `${B}/inv_misc_mohawkgrenade.jpg`,
  1252943: `${B}/spell_shaman_improvelavalash.jpg`,
  1256938: `${B}/ability_hunter_invigeration.jpg`,
  1262409: `${B}/ability_siege_engineer_detonate.jpg`,
  1272154: `${B}/ability_hunter_longevity.jpg`,
  1259003: `${B}/inv12_apextalent_hunter_raptorswipe.jpg`,
  // Choice sub-spells (spec)
  1253172: `${B}/inv_wildfirebomb_shrapnel.jpg`,
  1253176: `${B}/inv_wildfirebomb_blood.jpg`,
  385737: `${B}/ability_druid_disembowel.jpg`,
  1252738: `${B}/ability_butcher_heavyhanded.jpg`,
  1253945: `${B}/inv_ammo_bullet_08.jpg`,
  1261229: `${B}/inv_ammo_firetar.jpg`,
  1257011: `${B}/ability_rogue_findweakness.jpg`,
  462036: `${B}/inv_ore_blackrock_nugget.jpg`,

  // ── Sentinel ──
  1253599: `${B}/inv_ability_sentinelhunter_lunarstorm.jpg`,
  450373: `${B}/ability_racial_forceshield.jpg`,
  1253825: `${B}/spell_druid_lunarinspiration.jpg`,
  1253831: `${B}/inv_polearm_2h_arakkoa_c_01.jpg`,
  1264902: `${B}/inv_ability_hunter_deathchakram.jpg`,
  1253751: `${B}/icon_7fx_nightborn_astromancer_blue.jpg`,
  1253807: `${B}/spell_fire_flare.jpg`,
  1253830: `${B}/ability_hunter_aimedshot.jpg`,
  450379: `${B}/ability_mage_netherwindpresence.jpg`,
  1264904: `${B}/spell_nature_moonglow.jpg`,
  1266069: `${B}/ability_ambush.jpg`,
  1253846: `${B}/inv_10_specialreagentfoozles_tuskclawice.jpg`,
  1253852: `${B}/ability_hunter_sentinelowl.jpg`,
  1253887: `${B}/ability_racial_runningwild.jpg`,
  1253892: `${B}/sha_ability_rogue_bloodyeye.jpg`,
  1264903: `${B}/inv_misc_nightelfglaive.jpg`,
  1253732: `${B}/artifactability_balancedruid_moonandstars.jpg`,

  // ── Pack Leader ──
  471876: `${B}/inv_ability_packleaderhunter_vicioushunt.jpg`,
  472358: `${B}/spell_hunter_lonewolf.jpg`,
  472352: `${B}/inv_misc_horn_01.jpg`,
  472357: `${B}/ability_hunter_pathfinding2.jpg`,
  472719: `${B}/ability_heroicleap.jpg`,
  1268705: `${B}/ability_hunter_masterscall.jpg`,
  472476: `${B}/spell_druid_bearhug.jpg`,
  472524: `${B}/ability_druid_swipe.jpg`,
  472550: `${B}/spell_druid_feralchargecat.jpg`,
  472639: `${B}/inv_misc_boarshead.jpg`,
  1264781: `${B}/ability_hunter_criticalshot.jpg`,
  472660: `${B}/ability_hunter_goforthethroat.jpg`,
  472707: `${B}/inv_babyturtle2.jpg`,
  1264797: `${B}/ability_hunter_beastwithin.jpg`,
  1264792: `${B}/ability_deathwing_assualtaspects.jpg`,
  1264775: `${B}/inv_misc_monsterfang_02.jpg`,
  472741: `${B}/ability_hunter_bestialdiscipline.jpg`,
  472729: `${B}/inv_misc_rope_01.jpg`,

  // ── Hunter Class Tree ──
  385539: `${B}/ability_druid_galewinds.jpg`,
  264735: `${B}/spell_nature_spiritarmor.jpg`,
  109215: `${B}/ability_hunter_posthaste.jpg`,
  270581: `${B}/ability_hunter_onewithnature.jpg`,
  459450: `${B}/ability_rogue_plunderarmor.jpg`,
  1268871: `${B}/ability_hunter_combatexperience.jpg`,
  384799: `${B}/rogue_burstofspeed.jpg`,
  5116: `${B}/spell_frost_stun.jpg`,
  1258407: `${B}/ability_mount_jungletiger.jpg`,
  343242: `${B}/ability_hunter_mendpet.jpg`,
  1267003: `${B}/inv12_ability_hunter_rupturingblow.jpg`,
  459502: `${B}/inv_spear_01.jpg`,
  187707: `${B}/ability_hunter_negate.jpg`,
  378002: `${B}/ability_hunter_displacement.jpg`,
  19801: `${B}/spell_nature_drowsy.jpg`,
  343244: `${B}/hunter_pvp_vipersting.jpg`,
  1258486: `${B}/ability_rogue_feigndeath.jpg`,
  34477: `${B}/ability_hunter_misdirection.jpg`,
  459983: `${B}/spell_nature_drowsy.jpg`,
  459991: `${B}/spell_nature_drowsy.jpg`,
  459506: `${B}/achievment_raid_houroftwilight.jpg`,
  459534: `${B}/inv_10_engineering2_pvpflaregun_color1.jpg`,
  187698: `${B}/spell_yorsahj_bloodboil_black.jpg`,
  1513: `${B}/ability_druid_cower.jpg`,
  1258402: `${B}/inv12_ability_druid_lifetreading.jpg`,
  199483: `${B}/ability_hunter_camouflage.jpg`,
  459546: `${B}/ability_seal.jpg`,
  459542: `${B}/inv_misc_quiver_03.jpg`,
  459455: `${B}/ability_rogue_sprint.jpg`,
  1267218: `${B}/inv_cape_special_turtleshell_c_01.jpg`,
  19577: `${B}/ability_devour.jpg`,
  388039: `${B}/ability_hunter_huntervswild.jpg`,
  1258404: `${B}/ability_hunter_catlikereflexes.jpg`,
  1268868: `${B}/inv_fishing_nethooks01.jpg`,
  109248: `${B}/spell_shaman_bindelemental.jpg`,
  199921: `${B}/ability_hunter_aspectmastery.jpg`,
  459488: `${B}/ability_karoz_leap.jpg`,
  1268671: `${B}/ability_mage_icyfeet.jpg`,
  459507: `${B}/spell_nature_shamanrage.jpg`,
  1258509: `${B}/ability_druid_challangingroar.jpg`,
  266921: `${B}/ability_hunter_aspectoftheviper.jpg`,
  378004: `${B}/ability_hunter_silenthunter.jpg`,
  459460: `${B}/inv_misc_food_legion_goooil_pool.jpg`,
  1258485: `${B}/ability_hunter_pet_turtle.jpg`,
  343247: `${B}/ability_hunter_traplauncher.jpg`,
  459517: `${B}/inv_potion_29.jpg`,
  459527: `${B}/ability_hunter_potentvenom.jpg`,
  53480: `${B}/ability_hunter_fervor.jpg`,
  1272094: `${B}/spell_druid_bristlingfur.jpg`,
};
