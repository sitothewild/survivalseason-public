...
export const HUNTER_NODES: TalentNodeDef[] = [
  ...
  { id:'h_rejuvenating_wind', spellId:385539, name:'Rejuvenating Wind', type:'passive', maxPts:1, row:0, col:2,
    parents:[], desc:'Exhilaration now also heals you for an additional 12.0% of your maximum health over 8 sec.' },
  { id:'h_sotf', spellId:264735, name:'Survival of the Fittest', type:'active', maxPts:1, row:0, col:4,
    parents:[], desc:'Reduces all damage you and your pet take by 30% for 6 sec.' },
  { id:'h_posthaste', spellId:109215, name:'Posthaste', type:'passive', maxPts:1, row:0, col:6,
  ...
  // ROW 1 (API row 3)
  { id:'h_natural_mending', spellId:270581, name:'Natural Mending', type:'passive', maxPts:2, row:1, col:2,
    parents:['h_rejuvenating_wind'], desc:"Exhilaration's cooldown is reduced by 30 sec." },
  { id:'h_padded_armor', spellId:459450, name:'Padded Armor', type:'passive', maxPts:1, row:1, col:4,
    parents:['h_sotf'], desc:'Survival of the Fittest gains an additional charge.' },
  { id:'h_hunters_avoidance', spellId:384799, name:"Hunter's Avoidance", type:'passive', maxPts:1, row:1, col:6,
    parents:['h_posthaste'], desc:'Damage taken from area of effect attacks reduced by 5%.' },

  // ROW 2 (API row 4)
  { id:'h_wilderness_medicine', spellId:343242, name:'Wilderness Medicine', type:'passive', maxPts:1, row:2, col:1,
  ...
  { id:'h_combat_experience', spellId:1268871, name:'Combat Experience', type:'passive', maxPts:1, row:2, col:3,
  ...
  { id:'h_concussive_shot', spellId:5116, name:'Concussive Shot', type:'active', maxPts:1, row:2, col:7,
    parents:['h_hunters_avoidance'], desc:'Dazes the target, slowing movement speed by 50% for 6 sec.' },

  // ROW 3 (API row 5)
  { id:'h_precision_strikes', spellId:1267003, name:'Precision Strikes', type:'passive', maxPts:1, row:3, col:2,
    parents:['h_wilderness_medicine','h_combat_experience'], desc:'Your auto shot damage is increased by 25%.' },
  { id:'h_muzzle', spellId:187707, name:'Muzzle', type:'active', maxPts:1, row:3, col:4,
  ...
  { id:'h_serrated_tips', spellId:459502, name:'Serrated Tips', type:'passive', maxPts:2, row:3, col:6,
  ...
  { id:'h_tranq_shot', spellId:19801, name:'Tranquilizing Shot', type:'active', maxPts:1, row:4, col:1,
    parents:['h_precision_strikes'], desc:'Removes 1 Enrage and 1 Magic effect from an enemy target.' },
  { id:'h_pathfinding', spellId:378002, name:'Pathfinding', type:'passive', maxPts:1, row:4, col:3,
    parents:['h_precision_strikes','h_muzzle'], desc:'Movement speed increased by 4%.' },
  { id:'h_disruptive_rounds', spellId:343244, name:'Disruptive Rounds', type:'passive', maxPts:1, row:4, col:4,
    parents:['h_muzzle'], desc:'When Counter Shot interrupts a cast, gain 30 Focus.' },
  { id:'h_improved_feign', spellId:1258486, name:'Improved Feign Death', type:'passive', maxPts:2, row:4, col:5,
    parents:['h_muzzle','h_serrated_tips'], desc:'The cooldown of Feign Death is reduced by 5 sec.' },
  { id:'h_misdirection', spellId:34477, name:'Misdirection', type:'active', maxPts:1, row:4, col:7,
  ...
  // ROW 5 (API row 7)
  { id:'h_tranq_choice', spellId:null, name:'Kodo Tranquilizer / Devilsaur Tranquilizer', type:'choice', maxPts:1, row:5, col:1,
  ...
  { id:'h_kindling_flare', spellId:459506, name:'Kindling Flare', type:'passive', maxPts:1, row:5, col:2,
    parents:['h_tranq_shot','h_pathfinding'], desc:"Flare's radius is increased by 50%." },
  { id:'h_trigger_finger', spellId:459534, name:'Trigger Finger', type:'passive', maxPts:2, row:5, col:3,
    parents:['h_pathfinding','h_disruptive_rounds'], desc:'Haste increased by 1%.' },
  { id:'h_trap_choice', spellId:null, name:'Tar Trap / Scare Beast', type:'choice', maxPts:1, row:5, col:4,
  ...
  { id:'h_touch_of_grass', spellId:1258402, name:'Touch of Grass', type:'passive', maxPts:2, row:5, col:5,
    parents:['h_disruptive_rounds','h_improved_feign'], desc:'Your maximum health is increased by 5%.' },
  { id:'h_camouflage', spellId:199483, name:'Camouflage', type:'active', maxPts:1, row:5, col:6,
  ...
  { id:'h_no_hard_feelings', spellId:459546, name:'No Hard Feelings', type:'passive', maxPts:1, row:5, col:7,
  ...
  // ROW 6 (API row 8)
  { id:'h_improved_turtle', spellId:1258485, name:'Improved Aspect of the Turtle', type:'passive', maxPts:1, row:6, col:2,
    parents:['h_tranq_choice','h_kindling_flare','h_trigger_finger'], desc:'The cooldown of Aspect of the Turtle is reduced by 30 sec.' },
  { id:'h_specialized_arsenal', spellId:459542, name:'Specialized Arsenal', type:'passive', maxPts:1, row:6, col:4,
    parents:['h_trigger_finger','h_trap_choice','h_touch_of_grass'], desc:'Kill Command deals 10% increased damage.' },
  { id:'h_scouts_instincts', spellId:459455, name:"Scout's Instincts", type:'passive', maxPts:1, row:6, col:6,
  ...
  { id:'h_shell_wall', spellId:1267218, name:'Shell Wall', type:'passive', maxPts:1, row:7, col:1,
    parents:['h_improved_turtle'], desc:'Damage taken during Aspect of the Turtle is reduced by an additional 20%.' },
  { id:'h_intimidation', spellId:19577, name:'Intimidation', type:'active', maxPts:1, row:7, col:2,
    parents:['h_improved_turtle'], desc:'Commands your pet to intimidate the target, stunning for 5 sec.' },
  { id:'h_improved_snaring', spellId:1268868, name:'Improved Snaring', type:'passive', maxPts:1, row:7, col:3,
  ...
  { id:'h_lone_survivor', spellId:388039, name:'Lone Survivor', type:'passive', maxPts:1, row:7, col:4,
    parents:['h_specialized_arsenal'], desc:'The duration of Survival of the Fittest is increased by 2.0 sec.' },
  { id:'h_catlike_reflexes', spellId:1258404, name:'Catlike Reflexes', type:'passive', maxPts:1, row:7, col:5,
  ...
  { id:'h_binding_shot', spellId:109248, name:'Binding Shot', type:'active', maxPts:1, row:7, col:6,
  ...
  { id:'h_trailblazer_choice', spellId:null, name:'Trailblazer / Moment of Opportunity', type:'choice', maxPts:1, row:7, col:7,
  ...
  // ROW 8 (API row 10)
  { id:'h_cold_feet', spellId:1268671, name:'Cold Feet', type:'passive', maxPts:1, row:8, col:1,
    parents:['h_shell_wall'], desc:"When your Freezing Trap breaks, the victim's movement speed is reduced by 70% for 4 sec." },
  { id:'h_territorial_choice', spellId:null, name:'Territorial Instincts / Guttural Roar', type:'choice', maxPts:1, row:8, col:2,
  ...
  { id:'h_born_to_be_wild', spellId:266921, name:'Born To Be Wild', type:'passive', maxPts:2, row:8, col:3,
  ...
  { id:'h_keen_eyesight', spellId:378004, name:'Keen Eyesight', type:'passive', maxPts:2, row:8, col:5,
    parents:['h_lone_survivor','h_catlike_reflexes','h_binding_shot'], desc:'Critical strike chance increased by 2%.' },
  { id:'h_tether_choice', spellId:null, name:'Tar-Coated Bindings / Horsehair Tether', type:'choice', maxPts:1, row:8, col:6,
  ...
  { id:'h_improved_traps', spellId:343247, name:'Improved Traps', type:'passive', maxPts:1, row:8, col:7,
    parents:['h_binding_shot','h_trailblazer_choice'], desc:'The cooldown of Tar Trap and Freezing Trap is reduced by 5.0 sec.' },

  // ROW 9 (API row 11)
  { id:'h_emergency_salve', spellId:459517, name:'Emergency Salve', type:'passive', maxPts:1, row:9, col:2,
  ...
  { id:'h_guardian_choice', spellId:null, name:'Roar of Sacrifice / Guardian\'s Hide', type:'choice', maxPts:1, row:9, col:4,
  ...
  { id:'h_unnatural_causes', spellId:459527, name:'Unnatural Causes', type:'passive', maxPts:1, row:9, col:6,
